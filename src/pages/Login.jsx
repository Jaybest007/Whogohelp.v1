        ...
        <div className="flex justify-center items-center min-h-screen p-6 bg-gradient-to-br from-orange-100 to-orange-300">
            <div className="bg-white p-8 rounded-xl shadow-2xl w-full max-w-md">
                ...
                <p className="text-gray-500 text-center mb-4 text-sm">
                    Welcome back! Please sign in to continue.<br />
                    <span className="text-xs text-gray-400">Your credentials are safe and encrypted.</span>
                </p>
                ...
                <div className="mt-6 text-xs text-gray-400 text-center">
                    ...
                    Need an account? <Link to="/signup" className="text-orange-600 underline">Register here</Link>
                </div>
            </div>
        </div>
    );
