...
function Profile() {
  ...
  useEffect(() => {
    ...
    axios.post("https://api-hvzs.onrender.com/api/profile.php", { action: "fetchUserData", username: username }, {
  ...
  const updateProfile = async () => {
    ...
    setLoading(true);
    try {
      const response = await axios.post("https://api-hvzs.onrender.com/api/profile.php", {
        action: "edit_profile",
        about: newAbout,
        phone: newPhone,
